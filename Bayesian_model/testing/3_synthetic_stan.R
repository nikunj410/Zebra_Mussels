# Running 4 MCMC chains take ~16 hours to run on Macbook pro 2022 (Apple M1 Max) if ones uses all the ports as prior for introduction (# All 160 ports)
# Running 4 MCMC chains take ~1.5 hours to run on Macbook pro 2022 (Apple M1 Max) if one uses ports around lake Erie as prior for introduction (# 14 ports)
...
path = c("Bayesian_model/testing/data_files/synthetic_stan.rds")
